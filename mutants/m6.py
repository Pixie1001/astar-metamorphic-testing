...
class AStar(ABC, Generic[T]):
    ...
    def astar(
        ...
        startNode = searchNodes[start] = SearchNode(
            start, gscore=0.0, fscore=self.heuristic_cost_estimate(start, start)
        )
...
class MazeSolver(AStar):
    ...
    """sample use of the astar algorithm. In this example we work on a maze made of ascii characters,
